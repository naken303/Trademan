...
2. Open the app and confirm World data, village positions, routes, and market summaries load.
3. Create, edit, and delete a Product, Village, Route, and Market; confirm each list refreshes.
