...
export function WorldPage() {
  ...
  return <section className="world-page">
    ...
    <div className="world-editor"><ProductPalette products={world.products} onDragState={setProductDragActive} /><div className={productDragActive ? "canvas-shell dragging-product" : "canvas-shell"}><div className="canvas-hint"><strong>Directional routes</strong><span>Drag from a village's right handle to another village. Double-click an edge to edit.</span></div><WorldCanvas world={world} productDropActive={productDragActive} onProductDrop={dropProduct} onRouteConnect={connectRoute} onRouteEdit={editRoute} /></div></div>
